...
class TestUser(BaseTestCase):
    ...
    def test_bid_to_project(self):
        res = self.client.post('/bid/create', data=json.dumps({
    ...
    def test_get_my_bids(self):
        res = self.client.get('/bid/my-bids', data=json.dumps({
    ...
    def test_update_bids(self):
        res = self.client.patch('/bid/update', data=json.dumps({
            "email": self.user1.email,
            "password": "Password1",
            "bid_id": self.bid.id,
	        "amount": 300
    ...
    def test_delete_bid(self):
        res = self.client.delete('/bid/delete', data=json.dumps({
            "email": self.user1.email,
            "password": "Password1",
            "bid_id": self.bid.id,
        }),
